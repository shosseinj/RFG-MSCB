...
polyp segmentation performance can be achieved without a transformer-heavy architecture
...
branches with different receptive fields \cite{sknet}. These methods establish
descriptor-driven recalibration and adaptive receptive-field selection as relevant
precedents.
...
through bounded residual interpolation. The resulting mechanism combines established
descriptor-driven branch weighting with cross-level, bounded coupling to the MSCB
reference path.
...
Boundary awareness is introduced through the training objective rather than an
explicit boundary-refinement branch.
