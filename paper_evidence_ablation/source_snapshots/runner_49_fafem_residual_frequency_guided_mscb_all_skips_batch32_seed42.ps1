param(
    [ValidateSet(32)][int] $BatchSize = 32,
    [switch] $DryRun
)

$ErrorActionPreference = "Stop"
$experiment = "one_seed_49_fafem_residual_frequency_guided_mscb_all_skips_batch32"
$outputName = "49_fafem_residual_frequency_guided_mscb_all_skips_batch32"
...
try {
    & (Join-Path $PSScriptRoot "Invoke-OneSeed-Ablation.ps1") `
        ...
        -EnableResidualFGMSCBAllSkips $true `
