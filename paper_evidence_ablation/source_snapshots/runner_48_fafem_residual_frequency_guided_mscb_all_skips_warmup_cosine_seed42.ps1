...
$experiment = "one_seed_48_fafem_residual_frequency_guided_mscb_all_skips_warmup_cosine"
$outputName = "48_fafem_residual_frequency_guided_mscb_all_skips_warmup_cosine"
