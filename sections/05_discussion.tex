...
% TODO: insert the new seen-test and external-test interpretation after the final three-seed run.
...
CVC-300, 0.812/0.746 on CVC-ColonDB, and 0.816/0.763 on ETIS-LaribPolypDB.
CVC-300 therefore had the strongest external result among the three evaluated
datasets, while CVC-ColonDB and ETIS remained lower than the seen-domain results.
