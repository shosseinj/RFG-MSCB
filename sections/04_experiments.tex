...
We evaluate the final FAFEM + RFG-MSCB model quantitatively and qualitatively on five polyp segmentation datasets using random seeds 42, 6543, and 7777. The ablation experiments are described separately in \ref{ablation-study}.
...
methods. On CVC-ClinicDB, PFPRNet exceeded the model by 0.0120
...
$0.7870\pm0.0113$/$0.7071\pm0.0120$ on ETIS-LaribPolypDB. The model did not
...
respectively; values for this model are mean $\pm$ sample standard deviation.
...
and underlined, respectively; values for this model are mean $\pm$ sample standard
deviation.
...
bold and underlined, respectively; values for this model are mean $\pm$ sample
standard deviation.
