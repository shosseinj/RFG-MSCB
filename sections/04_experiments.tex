...
The three final runs used seeds 42, 6543, and 7777 and were implemented
...
epochs; seed 7777 stopped early at final epoch 167. The final model has
30,057,415 trainable and total parameters. At input size
$1\times3\times352\times352$, it requires 13.909244496 GMACs and
...
We present the quantitative and qualitative evaluation of the proposed architecture across five polyp segmentation datasets. The final results are reported for the three random seeds 42, 6543, and 7777 that jointly constitute Exp45. Ablation experiments are described separately in \ref{ablation-study}.
...
Results for the proposed method are reported as the mean $\pm$ sample
standard deviation over seeds 42, 6543, and 7777. On the two held-out
datasets, the method obtained mDice/mIoU of
$0.9313\pm0.0044$/$0.8826\pm0.0062$ on Kvasir-SEG and
$0.9370\pm0.0024$/$0.8877\pm0.0038$ on CVC-ClinicDB. In the displayed
comparisons, its Kvasir-SEG mDice was 0.0017 below CAFÉ-Net, while its
mIoU was 0.0064 below CAFÉ-Net and higher than the remaining listed
methods. On CVC-ClinicDB, PFPRNet exceeded the proposed method by 0.0120
mDice and 0.0153 mIoU.

On the external datasets, mDice/mIoU were
$0.8821\pm0.0016$/$0.8104\pm0.0018$ on CVC-300,
$0.7944\pm0.0089$/$0.7142\pm0.0086$ on CVC-ColonDB, and
$0.7870\pm0.0113$/$0.7071\pm0.0120$ on ETIS-LaribPolypDB. The proposed
method did not attain the highest displayed external-dataset mean. Its
largest between-seed variation in mDice and mIoU occurred on ETIS, with
sample standard deviations of 0.0113 and 0.0120, respectively. These
comparisons are descriptive; no statistical significance test between
...
\bottomrule\noalign{}
\endlastfoot
HCA-Net & \textbf{93.6} & \textbf{89.7} & \textbf{95.6} & \textbf{90.9} &
\textbf{91.2} & \textbf{87.3} & \textbf{83.4} & \textbf{76.9} &
\textbf{83.3} & \textbf{78.9} & -- \\
Ours & \underline{\meanstd{93.13}{0.44}} & \underline{\meanstd{88.26}{0.62}} &
\underline{\meanstd{93.70}{0.24}} & \underline{\meanstd{88.77}{0.38}} &
\underline{\meanstd{88.21}{0.16}} & \underline{\meanstd{81.04}{0.18}} &
\underline{\meanstd{79.44}{0.89}} & \underline{\meanstd{71.42}{0.86}} &
\underline{\meanstd{78.70}{1.13}} & \underline{\meanstd{70.71}{1.20}} & -- \\
\end{longtable}

The all-dataset summary reports percentages; our values are mean $\pm$
sample standard deviation over three seeds. Best and second-best values
are shown in bold and underlined, respectively.

Table 1 Quantitative comparison of various models on the Kvasir-SEG
dataset. Best and second-best values are shown in bold and underlined,
respectively; our values are mean $\pm$ sample standard deviation.
...
Ours & -- & \underline{\meanstd{0.9313}{0.0044}} &
\underline{\meanstd{0.8826}{0.0062}} & \meanstd{0.9113}{0.0053} &
\meanstd{0.9331}{0.0026} & \meanstd{0.9602}{0.0027} &
\meanstd{0.9665}{0.0026} & \meanstd{0.0240}{0.0007} \\
\end{longtable}
...
Ours & -- & \meanstd{0.9370}{0.0024} & \meanstd{0.8877}{0.0038} &
\meanstd{0.9254}{0.0027} & \meanstd{0.9466}{0.0012} &
\meanstd{0.9776}{0.0007} & \meanstd{0.9825}{0.0007} &
\meanstd{0.0109}{0.0003} \\
\end{longtable}

Table 3 Quantitative comparison of various models on the
ETIS-LaribPolypDB dataset. Best and second-best values are shown in bold
and underlined, respectively; our values are mean $\pm$ sample standard
deviation.
...
Ours & -- & \meanstd{0.7870}{0.0113} & \meanstd{0.7071}{0.0120} &
\meanstd{0.7532}{0.0074} & \meanstd{0.8780}{0.0037} &
\meanstd{0.9024}{0.0024} & \meanstd{0.9157}{0.0028} &
\meanstd{0.0146}{0.0008} \\
\end{longtable}
...
Ours & -- & \meanstd{0.7944}{0.0089} & \meanstd{0.7142}{0.0086} &
\meanstd{0.7715}{0.0066} & \meanstd{0.8612}{0.0060} &
\meanstd{0.8983}{0.0040} & \meanstd{0.9050}{0.0038} &
\meanstd{0.0349}{0.0010} \\
\end{longtable}

Table 5 Quantitative comparison of various models on the
CVC-300 (EndoScene) dataset. Best and second-best values are shown in
bold and underlined, respectively; our values are mean $\pm$ sample
standard deviation.
...
Ours & -- & \meanstd{0.8821}{0.0016} & \meanstd{0.8104}{0.0018} &
\meanstd{0.8571}{0.0010} & \meanstd{0.9281}{0.0030} &
\meanstd{0.9558}{0.0047} & \meanstd{0.9706}{0.0015} &
\meanstd{0.0074}{0.0003} \\
\end{longtable}
