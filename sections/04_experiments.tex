...
in PyTorch 2.5.1+cu124 with a maximum of 200 epochs and batch size 24.
AdamW with betas
...
epochs; seed 7777 stopped early at final epoch 167. Model complexity and
...
on the held-out and external datasets and places its performance alongside published
baselines. The quantitative results are presented first, followed by the qualitative
analysis section reserved for visual evidence.
...
comparisons, its Kvasir-SEG mDice was 0.17 percentage points below CAFÉ-Net, while its
mIoU was 0.64 percentage points below CAFÉ-Net and higher than the remaining listed
methods. On CVC-ClinicDB, PFPRNet exceeded the model by 1.20
percentage points in mDice and 1.53 percentage points in mIoU.

Across the comparison tables, the best and second-best values are shown in bold and
...
mIOU
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\[\mathbf{F}_{\boldsymbol{\beta}}^{\mathbf{w}}\]
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\[\mathbf{S}_{\boldsymbol{\alpha}}\]
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\[\mathbf{m}\mathbf{E}_{\boldsymbol{\xi}}\]
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\[\mathbf{\max}\mathbf{E}_{\boldsymbol{\xi}}\]
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
MAE
\end{minipage} \\
\endfirsthead
...
& 0.025 \\
CAFÉ-Net~\cite{cafenet} & 2024 & \textbf{0.933} & \textbf{0.889} & 0.927 &
...
\textbf{0.989} & -- &
\textbf{0.006} \\
PraNet-V2~\cite{pranetv2} & 2025 & 0.929 & 0.880 & -- & -- & -- & -- & 0.009 \\
...
0.007 \\
MSBP-Net~\cite{msbpnet} & 2025 & 0.903 & \textbf{0.859} & \textbf{0.927} & 0.942 & 0.967 & -- &
0.019 \\
