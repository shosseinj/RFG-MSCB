...
We evaluate the final FAFEM + RFG-MSCB model quantitatively and qualitatively on five polyp segmentation datasets using random seeds 42, 6543, and 7777. The ablation experiments are described separately in the ablation-study subsection.
...
Results for the model are reported as the mean $\pm$ sample
...
attain the highest displayed external-dataset mean. Its
largest between-seed variation in mDice and mIoU occurred on ETIS, with
sample standard deviations of 0.011 and 0.012, respectively. These
...
\caption{Quantitative comparison on Kvasir-SEG. Best and second-best values are shown in bold and underlined.}\label{tab:kvasir-comparison}\\
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.1130}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.0999}}@{}}
\caption{Quantitative comparison on CVC-ClinicDB. Best and second-best values are shown in bold and underlined.}\label{tab:clinicdb-comparison}\\
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Methods
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.1130}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.0999}}@{}}
\caption{Quantitative comparison on ETIS-LaribPolypDB. Best and second-best values are shown in bold and underlined.}\label{tab:etis-comparison}\\
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Methods
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.1003}}@{}}
\caption{Quantitative comparison on CVC-ColonDB. Best and second-best values are shown in bold and underlined.}\label{tab:colondb-comparison}\\
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Methods
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption{Quantitative comparison on CVC-300 (EndoScene). Best and second-best values are shown in bold and underlined.}\label{tab:cvc300-comparison}\\
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Methods
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
