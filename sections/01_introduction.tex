...
\item We quantify the architectural trade-off across the four-stage ablation: the localized RFG-MSCB modification adds 0.08 M parameters and 0.304 GFLOPs over FAFEM + MSCB.
\end{itemize}
