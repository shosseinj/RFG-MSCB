...
\item We evaluate the resulting ConvNeXt-Tiny segmentation architecture on five public colorectal polyp datasets using a three-seed comparison of Baseline, FAFEM + MSCB, and Residual RFG-MSCB configurations.
