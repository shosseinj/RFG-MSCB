...
Specifically, the final model combines a ConvNeXt-Tiny encoder, bottleneck
frequency enhancement, and efficient multi-scale decoding. We adopt the FAFEM
and MSCB structures; the new contribution is their cross-level coupling at the
Stage-3 fusion, which is developed technically in the next section.
